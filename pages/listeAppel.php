...
if(!empty($_GET["cour"]))
{
    ...
    <?php if($_SESSION["statut"] == "Professeur" || $_SESSION["statut"] == "Administration")
        { ?><div class='edt-cour-btn-block'><a class="btn btn-warning">Ajouter des Devoirs</a><a class="btn btn-primary">Ajouter un résumé du cours</a></div><?php }?>
    </div>
    <hr>
    ...
    if($_SESSION["statut"] == "Professeur" || $_SESSION["statut"] == "Administration")
    {
        ...
        <div id='appel-state' style="border-radius:50%;width:20px;height:20px;border:1px solid;background-color:
                    ...
                    "></div><h3 id='titre'>Fiche d'appel</h3></div><?php
