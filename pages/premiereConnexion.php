...
if(!empty($_SESSION) && $_SESSION["PremiereConnexion"] == 0)
{
    ...
    <div>    
        <div class="card col-12" style="margin-top : 100px">
            <div class="card-body">
                ...
                <div>
                    <h4>Article 1 : Les mentions légales <i class="fas fa-chevron-down"></i></h4></button>
                    <p id="CGU_article1">
                ...
                <div>
                    <h4>Article 2 : Accès au site <i class="fas fa-chevron-down"></i></h4></button>
                    <p id="CGU_article2">
    ...
    <script>
        ...
        {
            if(document.getElementById("CGU_article1").style.display === "none")
            {
                document.getElementById("CGU_article1").style.display = "block";
            }
            else if(document.getElementById("CGU_article1").style.display === "block")
            {
                document.getElementById("CGU_article1").style.display = "none";
            }
        }
        function displayArticle2()
        {
            if(document.getElementById("CGU_article2").style.display === "none")
            {
                document.getElementById("CGU_article2").style.display = "block";
            }
            else if(document.getElementById("CGU_article2").style.display === "block")
            {
                document.getElementById("CGU_article2").style.display = "none";
            }
        }
    </script>
