            ...
            if(!empty($_SESSION))
            {
                ...
                <?php
                    if(!empty($_SESSION["statut"]) && $_SESSION["statut"] == "Professeur")
                    {
                        ...
                        <li class="nav-item">
                            <a class="btn" id="lien" href="appel.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Emploi du temps</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="btn" id="lien" href="appel.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Fiche d'appel</a>
                        </li>

                        <li class="nav-item">
                            <a class="btn" id="lien" href="noteProf.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Note des eleve</a>
                        </li> 

                        <li class="nav-item">
                            <a class="btn" id="lien" href="devoirClasse.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Devoir des classes</a>
                        </li>

                        <li class="nav-item">
                            <a class="btn" id="lien" href="appel.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Profil</a>
                        </li>
                    ...
                    if(!empty($_SESSION["statut"]) && $_SESSION["statut"] == "Administration")
                    {
                        ...
                        <li class="nav-item">
                            <a class="btn" id="lien" href="salles.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Salle</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn" id="lien" href="appel.php"  style="border-radius:0; border-right: solid 1px white;font-size:1.1em; font-weight : bold; color : white;">Fiche d'appel</a>
                        </li>
